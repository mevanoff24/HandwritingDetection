...
#                 f.write(str(config.epoch) + ' ' + str(total_loss.item()) + ' ' + str(val_out) + '\n')
...
#         torch.save(optimizer.state_dict(), config.modelfile+'.optim')
#         output_config_file = config.modelfile+'.config.json'
